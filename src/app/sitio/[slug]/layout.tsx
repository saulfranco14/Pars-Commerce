...
export default async function SitioLayout({ children, params }: LayoutProps) {
  ...
  const { data: tenant, error: tenantError } = await supabase
    .from("tenants")
    .select(
      "id, name, description, theme_color, slug, whatsapp_phone, social_links",
    )
    .eq("slug", slug)
    .single();
          ...
          <div className="grid gap-8 sm:grid-cols-3">
            ...
            <div>
              ...
              <div className="flex gap-3">
                ...
                (tenant.social_links as Record<string, string> | null)
                  ?.instagram ||
                (tenant.social_links as Record<string, string> | null)
                  ?.facebook ||
                (tenant.social_links as Record<string, string> | null)
                  ...
                  <>
                    ...
                    {(tenant.social_links as Record<string, string> | null)
                      ...
                      <a
                        href={
                          (tenant.social_links as Record<string, string>)
                            .instagram
                        }
                        target="_blank"
                        rel="noopener noreferrer"
