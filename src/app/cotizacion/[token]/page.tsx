...
export default function CotizacionPublicaPage() {
  ...
  const { data, error, mutate } = useSWR<PublicQuote>(
    token ? `/api/public/quotes/${token}` : null,
    swrFetcher,
  );
