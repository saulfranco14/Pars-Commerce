...
/** Orígenes donde el cliente se lleva un número y paga en la caja. */
const COUNTER_SOURCES = new Set(["kiosk", "staff"]);

/**
 * El cliente llegó con su número y quiere pagar sin escanear nada. Si sí escaneó
 * y eligió efectivo, el cobro llega como pendiente y se confirma en
 * <PendingCashCard> — aquí no aparece nada.
 */
export function CounterPaymentCard() {
  ...
  if (!COUNTER_SOURCES.has(order.source ?? "")) return null;
