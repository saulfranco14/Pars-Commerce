...
export type QuickDateRange = "hoy" | "ayer" | "7dias";
...
interface DateFilterSheetProps {
  ...
  onQuickDate: (range: QuickDateRange) => void;
  onApply: () => void;
}

/**
 * Shared "Filtrar por fecha" bottom-sheet — the homologated date-filter used
 * across time-based list pages (órdenes, préstamos, suscripciones, ventas).
 * Purely presentational: date state + callbacks live in the page. Quick presets
 * (Hoy / Ayer / 7 días) + Desde/Hasta + Aplicar.
 */
